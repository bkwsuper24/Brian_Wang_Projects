...
{
	Product* SpecificBook = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
	return SpecificBook;
}
...
{
	Product* SpecificClothing = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
	return SpecificClothing;
}
...
{
	Product* SpecificMovie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
